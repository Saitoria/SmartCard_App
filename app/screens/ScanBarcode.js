...
function ScanBarcode()
{
    ...
    const [sem1pay,setSem1pay] = useState(null);
    const [sem1paytext,setSem1paytext] = useState(null);
    const [sem2pay,setSem2pay] = useState(null);
    const [sem2paytext,setSem2paytext] = useState(null);
  ...
  const viewStudentDetails = () => {
    ...
    {
      var retreaveAPIURL = "http://192.168.136.50:80/projects/smartcardAPI/retreave.php"; 
      var headers = {
      ...
      .then((response)=>
        {
          ...
          setSem1pay(response[0].sem1_pay);
          setSem2pay(response[0].sem2_pay);
    ...
    return(
      ...
      <ImageBackground 
        ...
        <View style={styles.detailsContainer}>
          ...
          <Text style={styles.detailsText}>Sem 1 paid: {sem1paytext} </Text>
          <Text style={styles.detailsText}>Sem 2 paid: {sem2paytext} </Text>
          </View>
        </View>
