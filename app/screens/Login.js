...
import {StyleSheet,View,Text,TextInput,TouchableOpacity,ImageBackground,TouchableWithoutFeedback,Keyboard,ScrollView, Dimensions,Image} from 'react-native';
...
export default class Login extends Component{
    ...
    SignUp = () => {
        ...
        {
            var loginAPIURL = "http://192.168.136.50:80/projects/smartcardAPI/login.php"; 
            var headers = {
    ...
    render()
    {
        return(
            ...
            <Text style={styles.titleTxt}>IDVS</Text>
            </View>

            <View style={styles.udsmlogo}>
            <Image
                source={require('../resources/udsmlogo.png')}
